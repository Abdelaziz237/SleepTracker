...
class SleepQualityFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val qualityViewModel = ViewModelProvider(this, factory)[SleepQualityViewModel::class.java]

        binding.qualityViewModel = qualityViewModel

        qualityViewModel.navigateToSleepTracker.observe(viewLifecycleOwner) {
